...
import { MissableBadge } from "@/components/missable-badge";
...
function TrophyIcon({ type }: { type: TrophyType }) {
  return (
    <div
      className={cn(
...
export function TrophyItem({ trophy, isComplete, onToggle }: TrophyItemProps) {
  return (
    <div
    ...
    >
      <Checkbox
        ...
        checked={isComplete}
        onCheckedChange={() => {}}
        className="mt-2 shrink-0 pointer-events-none"
      />
